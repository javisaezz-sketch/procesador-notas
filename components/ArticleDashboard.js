...
function ArticleCard({ articulo, isPublishing, isAnulando, onView, onPublish, onCancel }) {
  ...
  return (
    <div
      className={`flex flex-col rounded-2xl border border-slate-200 bg-white p-4 shadow-sm border-l-4 sm:p-6 ${theme.accent}`}
    >
      <div className="mb-3">
      ...
      <div className="mt-6 flex flex-col gap-3">
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            onClick={onPublish}
            disabled={isPublishing || isAnulando}
            className="flex-1 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 disabled:bg-indigo-400"
          >
  ...
  return (
    <>
      <section className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="inline-flex w-fit shrink-0 items-center rounded-full bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700 ring-1 ring-indigo-100">
          ...
          {mediosDisponibles.map((medio) => {
            ...
            return (
              ...
              >
                ...
                <span className="max-w-[6.5rem] truncate sm:max-w-none">{medio.nombre}</span>
